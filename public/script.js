...
//Wenn auf newsswitch geclickt wird, wird der Newsbereich sichtbar
document.getElementById('newsswitch').addEventListener('click', () => {
  var x = document.getElementById('newsbereich');
